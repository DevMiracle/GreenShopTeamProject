        ...
        <div className="slide2">
          <div className="wrapper">
            <div className="left-side">
              ...
              <div className="footer">
                Plants not only add a touch of nature to your home, but also
                purify the air, reduce stress, <br /> and boost creativity.
                Explore our selection of plants to find the perfect ones for
                your space.
              </div>
              <button className="shop-button">SHOP NOW</button>
            </div>
        ...
        <div className="slide3">
          <div className="wrapper">
            <div className="left-side">
              ...
              <div className="footer">
                Our plants aren't just beautiful, they're also versatile. From
                modern to bohemian, our collection <br /> of plants can
                complement any decor style. Shop now to find the perfect plant
                for your space.
              </div>
              <button className="shop-button">SHOP NOW</button>
            </div>
