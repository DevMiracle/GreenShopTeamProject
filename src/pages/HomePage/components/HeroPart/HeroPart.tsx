          ...
          <div className="wrapper">
            <div className="left-side">
              ...
              <div className="footer">
                ...
                <br /> and boost creativity. Explore our selection of plants to find the perfect ones for your
                space.
              </div>
              <button className="shop-button">SHOP NOW</button>
            </div>
          ...
          <div className="wrapper">
            <div className="left-side">
              ...
              <div className="footer">
                ...
                collection <br /> of plants can complement any decor style. Shop now to find the perfect plant
                for your space.
              </div>
              <button className="shop-button">SHOP NOW</button>
            </div>
